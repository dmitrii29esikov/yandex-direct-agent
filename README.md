...
> Было 18, стало 29: добавлены мультиаккаунтность и онлайн-аудит — см.
> дополнение от 21.09.2026 (вечер) в конце файла.
...
apply  — НЕ реализован осознанно: сначала смотрим 2–3 отчёта глазами и
         убеждаемся, что проверки не врут. Только потом включаем запись.
